...
def test_tool_call(db_session: sqlmodel.Session, city_chi: models.City, place_chi_1: models.Place, mocker):
    assert place_chi_1.tags == ["fashion"]
    ...
    assert result_dict["places"] == [place_chi_1]
