...
def page_links(path: str, params: starlette.datastructures.QueryParams, limit: int, total: int) -> tuple[str, str]:
    """
    ...
    if offset + limit < total:
        ...
        next_dict["offset"] = str(offset + limit)
    ...
    if offset - limit >= 0:
        ...
        if offset - limit > 0:
            prev_dict["offset"] = str(offset - limit)
        else:
